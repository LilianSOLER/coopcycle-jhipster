...
class RestaurantResourceIT {
    ...
    void createRestaurant() throws Exception {
        ...
        assertThat(testRestaurant.getCooperativeId()).isEqualTo(DEFAULT_COOPERATIVE_ID);
    }
    ...
    void putExistingRestaurant() throws Exception {
        ...
        assertThat(testRestaurant.getCooperativeId()).isEqualTo(UPDATED_COOPERATIVE_ID);
    }
