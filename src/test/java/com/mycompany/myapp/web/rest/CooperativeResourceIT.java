...
class CooperativeResourceIT {
    ...
    public static Cooperative createEntity(EntityManager em) {
        Cooperative cooperative = new Cooperative().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return cooperative;
    }
    ...
    public static Cooperative createUpdatedEntity(EntityManager em) {
        Cooperative cooperative = new Cooperative().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return cooperative;
    }
    ...
    void createCooperative() throws Exception {
        ...
        assertThat(testCooperative.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
    }
    ...
    void putExistingCooperative() throws Exception {
        ...
        updatedCooperative.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        ...
        assertThat(testCooperative.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
    }
    ...
    void partialUpdateCooperativeWithPatch() throws Exception {
        ...
        partialUpdatedCooperative.description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateCooperativeWithPatch() throws Exception {
        ...
        partialUpdatedCooperative.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
