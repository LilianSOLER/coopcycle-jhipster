...
class ItemResourceIT {
    ...
    public static Item createEntity(EntityManager em) {
        Item item = new Item().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).price(DEFAULT_PRICE).menuId(DEFAULT_MENU_ID);
        return item;
    }
    ...
    public static Item createUpdatedEntity(EntityManager em) {
        Item item = new Item().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).menuId(UPDATED_MENU_ID);
        return item;
    }
    ...
    void createItem() throws Exception {
        ...
        assertThat(testItem.getMenuId()).isEqualTo(DEFAULT_MENU_ID);
    }
    ...
    void putExistingItem() throws Exception {
        ...
        updatedItem.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).menuId(UPDATED_MENU_ID);
        ...
        assertThat(testItem.getMenuId()).isEqualTo(UPDATED_MENU_ID);
    }
    ...
    void partialUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.menuId(UPDATED_MENU_ID);
    ...
    void fullUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).menuId(UPDATED_MENU_ID);
